                ...
                <article>
                    <div class="container">
                      <form>
                        ...
                        <div class="mb-3 row">
                          <label for="repeat_password" class="col-sm-12 col-form-label">Contraseña</label>
                          <div class="col-sm-12">
                            <input type="password" class="form-control" name="repeat_password" id="repeat_password" placeholder="Ingrese el contraseña">
                          </div>
                        </div>
                        <div class="mb-3 row">
